import { type MonkeyOption, cdn } from "vite-plugin-monkey";

// s vite-油猴插件(vite-plugin-monkey) 的配置设置
export default {
	entry: "./src/main.ts",
	userscript: {
		name: "Resource Extractor Monkey",
		description: "网页资源聚合器",
		author: "AzureHearted", // 作者
		// updateURL: "", //更新地址
		version: "1.5.14",
		...
		namespace: "https://github.com/AzureHearted", // 命名空间
		match: ["*://*", "*://*/*"], // 要匹配的网站
		include: ["*"],
	...
	build: {
		fileName: "resource-extractor-monkey.user.js",
		externalGlobals: {
